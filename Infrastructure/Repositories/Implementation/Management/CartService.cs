...
namespace Infrastructure.Repositories.Implementation.Management
{
    public class CartService : ICartService
    {
        ...
        public CartService(BGSDbContext context, IHttpContextAccessor http, UserManager<User> userManager)
        {
            _context = context;
            _http = http;
        ...
        public async Task<bool> DoCheckout(CheckoutRequest model)
        {
            ...
            try
            {
				...
				var pendingRecord = _context.OrderStatus.FirstOrDefault(s => s.StatusName == StaticOrderStatus.Pending);
